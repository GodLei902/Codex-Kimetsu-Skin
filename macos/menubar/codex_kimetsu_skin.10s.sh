...
ENGINE="${CODEX_KIMETSU_SKIN_ENGINE:-$HOME/.codex/codex-kimetsu-skin}"
...
START="$SCRIPTS/start-kimetsu-skin-macos.sh"
PAUSE="$SCRIPTS/pause-kimetsu-skin-macos.sh"
CUSTOMIZE="$SCRIPTS/customize-theme-macos.sh"
RESTORE="$SCRIPTS/restore-kimetsu-skin-macos.sh"
STATUS="$SCRIPTS/status-kimetsu-skin-macos.sh"
