...
if [ "$UNINSTALL" = "true" ]; then
  /bin/rm -f "$HOME/Desktop/Codex Kimetsu Skin.command"
  /bin/rm -f "$HOME/Desktop/Codex Kimetsu Skin - Customize.command"
  /bin/rm -f "$HOME/Desktop/Codex Kimetsu Skin - Verify.command"
  /bin/rm -f "$HOME/Desktop/Codex Kimetsu Skin - Restore.command"
fi

printf 'Codex Kimetsu Skin was removed and the requested macOS restore actions completed successfully.\n'
